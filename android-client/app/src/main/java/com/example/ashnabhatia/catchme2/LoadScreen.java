...
public class LoadScreen extends ListActivity {
    ...
    // testing on Emulator:
    private static final String READ_COMMENTS_URL = "http://ehospitalcloud.webatu.com/readerList.php";
    ...
    private void updateList() {
        ...
        /*ListAdapter adapter = new SimpleAdapter(this, mCommentList,
                R.layout.single_post, new String[] { TAG_POST_ID, TAG_USERNAME,
                TAG_MESSAGE,TAG_TITLE }, new int[] { R.id.title, R.id.message,
    ...
    public class LoadComments extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(LoadScreen.this);
